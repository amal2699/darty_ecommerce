...
PATH_PRODUCTS_DATASET = "C:/Users/MSI GF63/Desktop/chores/data-encoder/ecommerce/vectors/data"
# Name of the zip file (without .zip extension)
NAME_DATASET = "bdd.json"
...
def calculate_products_image_vectors_clip(products_dataset):
    products_images = [calculate_product_image_vectors(
